...
class BodyCheckListQC extends StatefulWidget {
  const BodyCheckListQC({Key? key}) : super(key: key);

  @override
  State<BodyCheckListQC> createState() => _BodyCheckListQCState();
}

class _BodyCheckListQCState extends State<BodyCheckListQC> {
