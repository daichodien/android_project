...
class BodyCheckList extends StatefulWidget {
  const BodyCheckList({Key? key}) : super(key: key);

  @override
  State<BodyCheckList> createState() => _BodyCheckListState();
}

class _BodyCheckListState extends State<BodyCheckList> {
  ...
  String getUrl() {
    ...
    print("id=$id,\n driverID=$driverId\n fleet=$fleetDesc\n type=$type");
    var url =
        "https://fmbp.enterprise.vn:8108/inspection?bookno=&driverid=$driverId&equimentcode=$fleetDesc&userid=$id&type=$type";
    print(url);
    return url;
  }
